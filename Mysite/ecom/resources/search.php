...
function searchProducts()
{
  ...
  if (isset($_GET['search_data_product'])) {
    ...
    $select_query = "SELECT * FROM `products` WHERE product_keyword LIKE '%$value%' LIMIT $offset, $itemsPerPage";
        ...
        echo '<div class="col-md-3 mb-2">
                        ...
                        <div class="card-body">
                          ...
                          <div class="card-footer">
                            <a href="./resources/product_detail.php?product_id=' . $product_id . '" class="btn btn-primary">Chi tiet</a>
